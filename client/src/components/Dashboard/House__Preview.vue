<template>
  <div id="House__Preview">
    <dashboard title="House">
      <div v-if="isEmpty">
        <h1 style="margin-bottom: 20px;color:#888888;">You haven't created any House yet...!</h1>
        <router-link to @click.native="routing('/new_house')">Create New House</router-link>
      </div>
      <div v-else>
