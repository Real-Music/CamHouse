...
const { House, User } = require("../api/models");

let houses = [
  {
    slug: uniqueString(),
    imageUrl1: "/houses/2019-06-13T06:30:16.901Zpexels-photo-106399.jpeg",
    imageUrl2: "/houses/2019-06-13T06:30:16.902Zpexels-photo-106399.jpeg",
    imageUrl3: "/houses/2019-06-13T06:30:16.902Zpexels-photo-106399.jpeg",
    bathroom_no: 519,
    kitchen_no: 792,
    description:
...
async function Users() {
  ...
  houses.forEach(house => {
    ...
    house["floor_no"] = floors[floorIndex];
    house["userId"] = userId[tobeUseIndex];
    house["duration"] = duration[tobeUseDurationIndex];
    house.price = price[tobeUsePriceIndex];
    house.rooms_no = rooms[tobeUseRoomIndex];
    house.palors_no = parlor[tobeUseParlorIndex];
    house.kitchen_no = kitchen[kitchenIndex];
    house.location = location[tobeUseLocationIndex];
    house.bathroom_no = bathroom[bathroomIndex];
    house.dimension = dimension[dimensionIndex];
    tobeStoreHouse.push(house);
  });
  console.log(tobeStoreHouse);
  House.bulkCreate(tobeStoreHouse).then(data => {
    console.log(data);
  });
}
Users();
