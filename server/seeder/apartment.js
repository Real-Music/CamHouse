...
const { Apartment, User } = require("../api/models");

let apartments = [
  {
    slug: uniqueString(),
    imageUrl1: "/apartments/2019-06-13T06:18:33.445Zpexels-photo-259580.jpeg",
    imageUrl2: "/apartments/2019-06-13T06:18:33.446Zpexels-photo-259962.jpeg",
    imageUrl3: "/apartments/2019-06-13T06:18:33.446Zpexels-photo-279719.jpeg",
    bathroom_no: 519,
    kitchen_no: 792,
    description:
...
let price = [20000, 15000, 50000, 35000, 150000, 45000, 28000, 13000, 10000];
let rooms = [4, 3, 2, 1, 5];
let parlor = [1, 2];
let kitchen = [2, 1];
let bathroom = [4, 3, 1, 2];
let location = [
  "Bokwango",
  "Molyko",
  "milingo",
...
async function Users() {
  ...
  apartments.forEach(apartment => {
    ...
    apartment["userId"] = userId[tobeUseIndex];
    apartment["duration"] = duration[tobeUseDurationIndex];
    apartment.price = price[tobeUsePriceIndex];
    apartment.rooms_no = rooms[tobeUseRoomIndex];
    apartment.palors_no = parlor[tobeUseParlorIndex];
    apartment.kitchen_no = kitchen[kitchenIndex];
    apartment.location = location[tobeUseLocationIndex];
    apartment.bathroom_no = bathroom[bathroomIndex];

    console.log(apartment.price);
    tobeStoreApartment.push(apartment);
  });
  console.log(tobeStoreApartment);
  Apartment.bulkCreate(tobeStoreApartment).then(data => {
    console.log(data);
  });
}
Users();
