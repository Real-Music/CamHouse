...
const { Studio, User } = require("../api/models");

let studios = [
  {
    slug: uniqueString(),
    imageUrl1: "/studios/2019-06-13T06:51:04.040Zpexels-photo-2191606.jpeg",
    imageUrl2: "/studios/2019-06-13T06:51:04.040Zpexels-photo-2191606.jpeg",
    imageUrl3: "/studios/2019-06-13T06:51:04.040Zpexels-photo-2191606.jpeg",
    bathroom_no: 519,
    kitchen_no: 792,
    description:
...
async function Users() {
  ...
  studios.forEach(studio => {
    ...
    // studio["floor_no"] = floors[floorIndex];
    studio["userId"] = userId[tobeUseIndex];
    studio["duration"] = duration[tobeUseDurationIndex];
    studio.price = price[tobeUsePriceIndex];
    // studio.rooms_no = rooms[tobeUseRoomIndex];
    // studio.palors_no = parlor[tobeUseParlorIndex];
    studio.kitchen_no = kitchen[kitchenIndex];
    studio.location = location[tobeUseLocationIndex];
    studio.bathroom_no = bathroom[bathroomIndex];
    // studio.dimension = dimension[dimensionIndex];
    tobeStoreStudio.push(studio);
  });
  console.log(tobeStoreStudio);
  Studio.bulkCreate(tobeStoreStudio).then(data => {
    console.log(data);
  });
}
Users();
